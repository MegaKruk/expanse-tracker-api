...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    private static final String SQL_FIND_ALL =
            ...
            "COALESCE(SUM(T.AMOUNT), 0) TOTAL_EXPANSE FROM ET_TRANSACTIONS T " +
            "RIGHT OUTER JOIN ET_CATEGORIES C ON C.CATEGORY_ID = " +
    ...
    public static final String SQL_DELETE_ALL_TRANSACTIONS =
